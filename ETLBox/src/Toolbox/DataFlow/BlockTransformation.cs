...
namespace ALE.ETLBox.DataFlow
{
    ...
    /// </code>
    /// </example>
    public class BlockTransformation<TInput, TOutput> : DataFlowTask, ITask, IDataFlowLinkTarget<TInput>, IDataFlowLinkSource<TOutput>, IDataFlowTask<TOutput>
    {
        /* ITask Interface */
        ...
        public IDataFlowTask<TOutput> IDataFlowTask<TOutput>.Link(IDataFlowLinkTarget<TOutput> target)
        {
            this.LinkTo(target);
            return target as IDataFlowTask<TOutput>;
        }

        public IDataFlowTask<TOutput> IDataFlowTask<TOutput>.Link(IDataFlowLinkTarget<TOutput> target, Predicate<TOutput> predicate)
        {
